...
export const description = "add table for alerts";
...
export async function up(client) {
  ...
  await waitForTableToBecomeActive(client, "alertHistory");
}
...
export async function down(client) {
  ...
  await waitForTableToBecomeDeleted(client, "alertHistory");
}
